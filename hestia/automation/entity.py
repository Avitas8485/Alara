...
class Entity:
    ...
    def add_entity_state(self):
        self.handler.state_machine.add_state(State(entity_id=self.entity_id, state=self.state, attributes=self.attributes))
...
class Lights(Entity):
    ...
    def set_brightness(self, brightness):
        ...
        self.handler.event_bus.emit_event(Event("lights_brightness_changed", {"entity_id": self.entity_id, "brightness": brightness}))
...
class Thermostat(Entity):
    ...
    def turn_on(self, temperature):
        ...
        self.handler.event_bus.emit_event(Event("thermostat_on", {"entity_id": self.entity_id, "temperature": temperature}))
    ...
    def set_temperature(self, temperature):
        self.update_entity_state("on", {"temperature": temperature})
        self.handler.event_bus.emit_event(Event("thermostat_temperature_changed", {"entity_id": self.entity_id, "temperature": temperature}))
